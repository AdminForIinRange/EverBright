...
const ReviewCard = ({ name, date, reviewText, stars, platform, avatar, verified = false }) => (
  <Box
    bg="white"
    p="6"
    borderRadius="2xl"
  ...
  >
    ...
    <VStack spacing="5" align="start" >
      ...
      <HStack spacing="1" py={"4"}>
        {[...Array(5)].map((_, index) => (
          <FaStar
            ...
            style={{
              filter: index < stars ? "drop-shadow(0 1px 2px rgba(246, 173, 85, 0.3))" : "none",
            }}
          />
        ))}
      </HStack>
      ...
      {/* Review Text */}
      <Text fontSize="sm" color="gray.600" lineHeight="1.6" letterSpacing="0.01em">
        {reviewText}
      </Text>
    </VStack>
  </Box>
              ...
              <HStack spacing="1">
                {[...Array(5)].map((_, index) => (
                  <FaStar
                    ...
                    size={20}
                    color="#F6AD55"
                    style={{ filter: "drop-shadow(0 1px 2px rgba(246, 173, 85, 0.3))" }}
                  />
                ))}
              </HStack>
              <Text fontSize="xl" fontWeight="800" color="gray.800">
